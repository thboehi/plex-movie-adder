...
export default function Navbar({ current }) {
  ...
  return (
    <>
        <nav className="border-gray-200 bg-gray-100 dark:bg-gray-800 dark:border-gray-700 sticky top-0 z-50">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <ul className="flex flex-col font-medium mt-4 gap-2 rounded-lg bg-gray-100 dark:bg-gray-800 dark:border-gray-700">
