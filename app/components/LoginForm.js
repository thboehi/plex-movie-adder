      ...
      <div className={`min-h-svh w-full overscroll-none overflow-hidden fixed flex flex-col items-center justify-center p-8 z-[55] transition-all duration-300 ${
        ...
        <header className="flex flex-col items-center mb-12 z-50">
          ...
          <div className="w-40 mb-1">
            ...
            {/* LOGO SVG FOND BLANC POUR MODE SOMBRE */}
            <svg
              id="Calque_2"
              data-name="Calque 2"
          ...
          <>
            ...
            <div>
              <input
                ...
                className="block w-full max-w-md p-3 text-lg border border-gray-800 rounded-md outline-none focus:border-orange focus:ring-2 focus:ring-orange hover:border-orange bg-gray-900 text-white transition-colors"
              />
              <Checkbox
            ...
            <button
              type="submit"
              className="block border border-gray-800 py-2 px-3 text-white rounded-lg bg-gray-900 hover:border-orange transition-colors w-full self-end place-self-end cursor-pointer"
            >
              Se connecter
            </button>
