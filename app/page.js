...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-black p-8">
      ...
      {/* Section "Information" déroulante */}
      <details className="max-w-xl bg-white border border-gray-200 dark:bg-gray-950 dark:border-gray-800 p-4 rounded-md mb-8 text-xs">
        <summary className="cursor-pointer font-semibold text-gray-700 dark:text-gray-50">
          Information
        </summary>
        <p className="text-gray-600 dark:text-gray-50 my-2">
          Ce site permet d'ajouter des films manquants sur le serveur Plex.
        </p>
        <p className="text-gray-600 dark:text-gray-50 mb-2">
          De temps en temps, les administrateurs consultent cette liste de films et, s'ils sont disponibles au téléchargement, nous les ajoutons sur Plex..
        </p>
        <p className="text-gray-600 dark:text-gray-50">
          Notez que les films venant de sortir au cinéma prennent souvent <strong>quelques mois avant d'être disponibles</strong>.
        </p>
      </details>
